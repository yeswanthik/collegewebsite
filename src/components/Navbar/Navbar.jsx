...
export const Navbarhead = () => {
  ...
  return (
    <Container className=" w-100  mb-3 ">
      <Navbar
        expand="lg"
        className=" d-block d-sm-none justify-content-center w-100  text-dark  "
        style={{ backgroundColor: "#d86110" }}
      >
        <Navbar.Toggle
        ...
        <Navbar.Collapse id="basic-navbar-nav ">
          <Nav className="me-auto justify-content-center w-100 text-light p-3 ">
            ...
            <NavDropdown
              title={
                <span className={`text-${showDropdown ? "dark" : "light"}`}>
                  About Us
                </span>
              }
            ...
            >
              ...
              <NavDropdown.Item href="/visionandmission">
                Vision & Mission
              </NavDropdown.Item>
              <NavDropdown.Item href="/chairman">
                Chairman Message
              </NavDropdown.Item>
              ...
              <NavDropdown.Item href="/collegedetails">
                College Details
              </NavDropdown.Item>
            ...
            <NavDropdown
              title={
                <span
                  className={`text-${showWhyKGCDropdown ? "dark" : "light"}`}
                >
                  Why KGC
                </span>
              }
            ...
            >
              <NavDropdown.Item href="/whykgc#blog-1">
                Right to Vote
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-2">
                Anti Ragging
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-3">
                Scholarships
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-4">
                Career Coaching
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-5">
                Youth Club
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-6">Library</NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-7">Lab</NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-8">
                Auditorium
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-9">
                Gurudwara Sahib
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-10">
                Open Air Theater
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-11">
                Smart Classes
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-12">
                Cafeteria
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-13">
                Health Care
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-14">
                Multi Purpose Hall
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-15">
                Parent Teacher Association
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-16">
                Student Council
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-17">
                Campus Security Camera Systems
              </NavDropdown.Item>
              <NavDropdown.Item href="/whykgc#blog-18">
                Save Water
              </NavDropdown.Item>
            </NavDropdown>
            ...
            <NavDropdown
              title={
                <span className={`text-${showCourse ? "dark" : "light"}`}>
                  Courses
                </span>
              }
              id="about-us-dropdown"
            ...
            >
              ...
              >
                <NavDropdown.Item
                  ...
                  onClick={() => {
                    handleDownload("/pdf/botanybsc.pdf", "Botony");
                  }}
                >
                  {" "}
                  Botony Syllabus
                ...
                <NavDropdown.Item
                  style={{ fontSize: "smaller" }}
                  onClick={() => {
                    handleDownload("/pdf/zoobsc.pdf", "Zoology Syllabus");
                  }}
                >
                  Zoology Syllabus
                </NavDropdown.Item>
                <NavDropdown.Item
                  style={{ fontSize: "smaller" }}
                  onClick={() => {
                    handleDownload("/pdf/babscmaths.pdf", "Maths Syllabus");
                  }}
                >
                  Maths Syllabus
                </NavDropdown.Item>
                <NavDropdown.Item
                  style={{ fontSize: "smaller" }}
                  onClick={() => {
                    handleDownload("/pdf/bscchem.pdf", "Chemistry Syllabus");
                  }}
                >
                  Chemistry Syllabus
                </NavDropdown.Item>
              ...
              >
                <NavDropdown.Item
                  style={{ fontSize: "smaller" }}
                  onClick={() => {
                    handleDownload("/pdf/baps.pdf", "political science");
                  }}
                >
                  {" "}
                ...
                <NavDropdown.Item
                  style={{ fontSize: "smaller" }}
                  onClick={() => {
                    handleDownload("/pdf/baeng.pdf", "English Syllabus");
                  }}
                >
                  English Syllabus
                </NavDropdown.Item>
            ...
            <NavDropdown
              title={
                <span className={`text-${showAdmission ? "dark" : "light"}`}>
                  Admission
                </span>
              }
              id="about-us-dropdown"
      ...
      <header
        className={`header navbar-brand d-flex align-items-center justify-content-center  ${
          isSmallScreen ? "pb-3" : "pt-3"
        }`}
        style={{ backgroundColor: "#d86110" }}
      >
        <div
          style={{ backgroundColor: "white" }}
          className="d-flex align-items-center justify-content-center w-100 flex-column flex-md-row"
        >
      ...
      <Navbar
        expand="lg"
        className=" justify-content-center w-100 d-none d-sm-block  text-dark  "
        style={{ backgroundColor: "#d86110" }}
      >
        <Navbar.Toggle
          aria-controls="basic-navbar-nav"
        ...
        <Navbar.Collapse id="basic-navbar-nav ">
          <Nav className="me-auto justify-content-center w-100 text-light ">
            ...
            >
              ...
              <NavDropdown.Item href="/president">
                President Message
              </NavDropdown.Item>
