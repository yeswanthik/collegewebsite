    ...
    <Container className='mb-5'>
      <Navbar.Brand>
        <Link to="/" className='navbar-brand d-flex align-items-center'>
          ...
          <span className='mx-2 text-light lh-1 fw-semibold d-block d-sm-none'>
          KGCSS
          ...
          <span className='mx-2 text-light lh-1 fw-semibold d-none d-sm-block'>
      ...
      <Navbar.Toggle aria-controls='basic-navbar-nav' className='bg-light'style={{ fontSize: '0.8rem',marginTop: '0.25rem' }}                 />
