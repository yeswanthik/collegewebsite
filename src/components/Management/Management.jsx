...
import Secretary from '../../utils/images/Mohar.jpg'
...
President </p></div>
            ...
            <div className="row mb-5">
                <div className='col-lg-8 d-flex flex-column  mb-4 mb-lg-0 order-2 order-lg-1'>
...
<p style={{fontWeight:"bold"}}>Sukhvinder Kaur Sidhu,
...
<div className="row mb-5">
                    ...
                    <div className='col-lg-8 d-flex flex-column   mb-lg-0 order-2 order-lg-1'>
    ...
    <div className='col-lg-4 d-flex mt-5 justify-content-center order-1 order-lg-2'>
                        <img src={Principal} style={{width:"350px", height:"350px"}}  alt="" />
                    </div>
    </div>
<div className="row">


                <div className='col-lg-12 d-flex flex-column justify-content-center mb-4 mb-lg-0'>

            <div className='   container h-100 d-flex flex-column  justify-content-center text-dark'>
                <h3 className=' fw-semibold'>Dear Students,</h3>
                <p className='mb-3'>
