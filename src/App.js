        ...
        <div className='container my-5 p-3' style={{backgroundColor:"#d86110"}}>
          <div className='row d-flex justify-content-between align-items-center'>
            <div className='col-md-4'>
              ...
              <ul className='footer-social-icons list-unstyled d-flex gap-5 '>
                <Link to="/contact">
                  <li>
                ...
                <Link to="https://www.instagram.com/khalsagirlscollege_sadulshahar?igsh=cmZhZzY1MzlkYmcz" target='_blank'>
                  <li>
                ...
                <Link to="https://youtube.com/@khalsacollege7702?si=7CZlu7BG7KMuo2pc"  target="_blank">
                  <li>
            ...
            <div className='col-md-4'>
          <p style={{color:"#FFFFFF"}}>View on Google Maps</p>
    <iframe
        src="https://www.google.com/maps?q=29.91733599590189,74.18012682531497&output=embed"
       title='Khalsa'
        style={{ border: 0, width: '100%', maxWidth: '600px', height: 'auto' }}
        loading="lazy"
        allowFullScreen
    ></iframe>
            </div>
              ...
              <div className='d-row d-md-flex justify-content-between align-items-center'>
                <div className='col-12 col-md-6 col-lg-5 mb-5 mt-4 my-md-0'>
                  <ul className='footer-navigation list-unstyled mb-1'>
                    ...
                    <Link to="/management" className='text-decoration-none ' style={{color:"#FFFFFF"}}>
                ...
                <div className='col-12 col-md-6 col-lg-7'>
                  <ul className='list-unstyled mb-0' style={{color:"#FFFFFF"}}>
                    <li>
                    <p>Address: Ward no-19 Adarsh colony Sadul Sahar Dist:Sri Ganganagar, Rajasthan India-335062</p>
                    </li>
                    {/* <li>
                      <p>Phone Number-1503 222464</p>
                    </li> */}
                    <li>
                    <p>Contact: +91-9314355027, +91-9414508064</p>
                    </li>
                    <li>
